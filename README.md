...
Frontend deckbuilder helper logic currently lives in `apps/deckbuilder-ui/src/deckUiLogic.ts`; `App.tsx` should stay focused on rendering and state orchestration.
