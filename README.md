...
Current verified baseline: from `G:\Documents\New MTG project`, `python -m unittest discover -s tests` passes with 343 tests after Color Identity Workspace Projection v0.
